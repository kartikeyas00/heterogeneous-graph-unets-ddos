#!/usr/bin/env python3
"""
Comprehensive Pipeline for BCCC-CPacket-Cloud-DDoS-2024 Dataset
================================================================

This pipeline automates the complete workflow for training and evaluating 
graph neural network models on the BCCC-CPacket-Cloud-DDoS-2024 dataset.
...
def main():
    ...
    logging.info("=" * 60)
    logging.info("BCCC-CPACKET-CLOUD-DDOS-2024 PIPELINE")
    logging.info("=" * 60)
