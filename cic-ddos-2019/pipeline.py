#!/usr/bin/env python3
"""
Comprehensive Pipeline for CIC-DDoS-2019 Dataset
==============================================

This pipeline automates the complete workflow for training and evaluating 
graph neural network models on the CIC-DDoS-2019 dataset.
...
def preprocess_data(config):
    ...
    if raw_data_config.get('enabled', False):
        ...
        cmd = [
            ...
            "--input-dirs"] + raw_data_config['input_dirs'] + [
            "--output-dir", raw_data_config['output_dir'],
            "--output-filename", raw_data_config.get('output_filename', 'features.csv')
        ]
...
def main():
    ...
    logging.info("=" * 60)
    logging.info("CIC-DDoS-2019 PIPELINE")
    logging.info("=" * 60)
